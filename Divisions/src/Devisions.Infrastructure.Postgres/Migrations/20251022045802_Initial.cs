        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    identify = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    houseNumber = table.Column<int>(type: "integer", maxLength: 5, nullable: false),
                    roomNumber = table.Column<int>(type: "integer", maxLength: 5, nullable: true),
                    is_active = table.Column<bool>(type: "boolean", nullable: false),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "address_unique",
                table: "locations",
                columns: new[] { "country", "city", "street", "houseNumber", "roomNumber" },
                unique: true);
